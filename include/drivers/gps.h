...
struct gps_config {
	 ...
	 * ignored outside periodic mode. Minimum accpeted value is 10 seconds.
	 */
	u32_t interval;
...
enum gps_event_type {
	...
	GPS_EVT_NMEA,
	GPS_EVT_NMEA_FIX,
	GPS_EVT_NO_TIME_WINDOW,
	GPS_EVT_HAS_TIME_WINDOW,
 ...
 *
 * @param dev Pointer to GPS device
 * @param cfg Pointer to GPS configuration. If NULL, continuous search is used.
 */
 ...
 * @param data Pointer to A-GPS dat
 *
