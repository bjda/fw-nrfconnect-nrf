...
#define UI_LTE_DISCONNECTED_COLOR	UI_LED_COLOR_RED
#define UI_LTE_CONNECTING_COLOR		UI_LED_COLOR_RED
#define UI_LTE_CONNECTED_COLOR		UI_LED_COLOR_RED
#define UI_CLOUD_CONNECTING_COLOR	UI_LED_COLOR_RED
#define UI_CLOUD_CONNECTED_COLOR	UI_LED_COLOR_RED
#define UI_CLOUD_PAIRING_COLOR		UI_LED_COLOR_RED
#define UI_ACCEL_CALIBRATING_COLOR	UI_LED_COLOR_RED
...
#define UI_LED_ERROR_UNKNOWN_COLOR	UI_LED_COLOR_RED
#define UI_LED_GPS_SEARCHING_COLOR	UI_LED_COLOR_RED
#define UI_LED_GPS_FIX_COLOR		UI_LED_COLOR_RED
